  ...
  String typeLabel(BuildContext context) {
    switch (type) {
      case OpsNavDestType.patientPickup:
        return context.l10n.navigateToPatient;
      case OpsNavDestType.hospital:
        return context.l10n.navigateToHospital;
      case OpsNavDestType.returnDest:
        return context.l10n.navigateReturn;
    }
  }
...
class NavigationService {
  ...
  static Future<bool> _tryGoogleMapsUrl(
  ...
  static void showNavigationPicker(
      BuildContext context, OpsNavDestination dest) {
    debugPrint(
      ...
      builder: (_) => SafeArea(
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              Text(
                '${dest.typeIcon} ${dest.typeLabel(context)}',
              ...
              ListTile(
                ...
                subtitle: Text(context.l10n.googleMapsSubtitle,
                    style: const TextStyle(
                        color: AppColors.textSecondary, fontSize: 11)),
                onTap: () {
              ...
              ListTile(
                ...
                title: Text(context.l10n.waze,
                    style: const TextStyle(color: AppColors.textPrimary)),
                subtitle: Text(context.l10n.wazeSubtitle,
                    style: const TextStyle(
                        color: AppColors.textSecondary, fontSize: 11)),
                onTap: () {
                  Navigator.pop(context);
